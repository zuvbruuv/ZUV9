...
local ClosureBindings = {
	function()local wax,script,require=ImportGlobals(1)local ImportGlobals return (function(...)local Lighting = game:GetService("Lighting")
			...
			local UIVersion = loadstring(game:HttpGet('https://raw.githubusercontent.com/zuvbruuv/Therion/main/Version.lua', true))() or "v1.0.0"
			local Root = script
	...
	[24] = function()local wax,script,require=ImportGlobals(24)local ImportGlobals return (function(...)local Root = script.Parent.Parent
			...
			function Element:New(Idx, Config)
				...
				do 
					if Config.Toggle then	
						assert(Config.Toggle and Config.Toggle.Flag, "Input Toggle - Missing flag!")
